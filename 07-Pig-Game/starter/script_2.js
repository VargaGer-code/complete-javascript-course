...
const first = function (egg, chicken) {
  console.log(egg, chicken);
  const secondInFirst = function (egg, chicken) {
    console.log(`The ${chicken} have ${egg}`);
    secondInFirst(egg, chicken);
  };
};
